...
insert_stmt="INSERT INTO host_info(hostname, timestamp, memory_free, cpu_idle, cpu_kernel, disk_io, disk_available) VALUES ('$hostname', '$timestamp', '$memory_free','$cpu_idle','$cpu_kernel','$disk_io','$disk_available')"
